...
LINEAR_SERVER_URL = 'https://linear-model-service-franciscomj0398.cloud.okteto.net/v1/models/linear-model:predict'

RESNET_SERVER_URL = 'https://resnet-service-franciscomj0398.cloud.okteto.net/v1/models/resnet:predict'
